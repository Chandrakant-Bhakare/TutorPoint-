    ...
    <div className="container">
      <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li>
          <Link to='/studentprofile' className="nav-link px-2 text-white">Profile</Link>
            {/* <a href="#" className="nav-link px-2 text-white">
              
            </a> */}
          </li>
          <li>
          <Link to='/students/bookclass' className="nav-link px-2 text-white">Book A Class</Link>
          </li>
          <li>
          <Link to='/bookings' className="nav-link px-2 text-white">My Bookings</Link>
          </li>
        </ul>
        <div className="text-end">
          <button type="button" className="btn btn-warning student-portal" onClick={moveToHome}>
            Logout
          </button>
        </div>
      </div>
